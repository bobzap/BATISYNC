/*
  # Tables pour l'extraction de données des contrats
  
  1. Nouvelles Tables
    - `contract_extracted_data`: Stocke les métadonnées des extractions par section
    - `contract_data_rows`: Stocke les lignes de données extraites
    
  2. Sections
    - Articles: Détails des articles du contrat
    - Conditions: Conditions générales du contrat
    - Conditions Spéciales: Conditions particulières du contrat
